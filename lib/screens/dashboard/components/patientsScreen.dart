...
import 'package:admin/models/patientsData.dart';
            ...
            child: Expanded(
                ...
                children: [
                  Text(
                   ...
                   RawMaterialButton(
                    ...
                    child: Text("Add Patients",style: TextStyle(color: Colors.white,fontSize: 12),),
                    onPressed: (){})
                ],
              ),
              SizedBox(height: defaultPadding,),
              ...
              SizedBox(
                ...
                child: DataTable(
                  ...
                  rows: List.generate(
                    demoPatientDatas.length,
                    (index) => PatientDataDataRow(demoPatientDatas[index]),
                  ),
                ),
              ),
              ],
...
DataRow PatientDataDataRow(PatientData fileInfo) {
  return DataRow(
    cells: [
      // DataCell(
      //   Row(
